...
export function Auth({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ✅ CORRECTION 1: Validation email améliorée
      ...
      // ✅ CORRECTION 2: Accepter 'admin' sans @ et les emails normaux
      ...
      if (isLogin) {
        ...
        // Validation pour création de compte (email normal requis)
        if (!formData.email.includes('@')) {
          setError('Veuillez saisir un email valide pour la création de compte')
          setLoading(false)
          return
        }
            ...
            <div className="form-group">
              ...
              <div className="input-container">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="input-field"
                  placeholder="admin ou exemple@email.com"
                />
              </div>
            </div>
